...
2. Calls Anthropic API with a structured prompt
3. Returns `{ feedback: "..." }`
...
2. Firebase connects automatically using the embedded config
3. To test the Netlify function locally, install Netlify CLI and run `netlify dev`
